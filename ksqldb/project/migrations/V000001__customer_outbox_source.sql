...
from the OutboxItem table in the customer service.
Since the events are already serialized according to the canonical
schema for customer entity events, the events are produced directly
to the public topic.
*/

CREATE SOURCE CONNECTOR customer_outbox_source WITH (
    ...
    'database.server.name' = 'customer-service',
    'slot.name' = 'customer_service_debezium',
