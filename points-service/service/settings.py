...
SESSION_COOKIE_NAME = "points-service"

EVENTS = {
    "TYPES": [
        {
            "NAME": "customer_entity_state",
            "SCHEMA": "customer.avsc",
            "TOPIC": "public_customer_entity_events",
        },
        {
            "NAME": "order_created",
            "SCHEMA": "order.avsc",
            "TOPIC": "public_order_entity_events",
        },
    ],
    ...
    "SCHEMAS_DIR": "schemas",
    "EVENT_SOURCE_NAME": "points-service",
}
